            ...
            if product is None:
                ...
                if item: 
                    ...
                    if not quantity:
                        ...
                        return make_response(jsonify("Item has been removed"), 200)
                    ...
                    if new_product.quantity < 0:
                        return make_response(jsonify("Quantity of the product in the cart exceeded the quantity in stock"), 400)
